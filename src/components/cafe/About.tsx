...
export function About() {
  return (
    <section className="relative py-20 sm:py-28 px-3 sm:px-5 overflow-hidden">
      <div className="absolute -top-40 -left-40 w-[440px] h-[440px] rounded-full bg-caramel/10 blur-[120px]" />
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-14 items-center">
        <div className="relative">
          ...
          <div className="absolute -bottom-5 sm:-bottom-6 -right-4 sm:-right-6 glass-strong rounded-2xl p-5 shadow-glow w-40 sm:w-44">
            <p className="font-display text-3xl text-caramel">3+</p>
            <p className="text-xs text-foreground/70 mt-1">years brewing happiness in Navsari</p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-10 grid sm:grid-cols-3 gap-4">
            {[
              ...
              { icon: Heart, t: "Cozy vibes", d: "A second home in Navsari" },
